...
INSERT INTO issue(title, description, reporter_id, status, project_id) VALUES('Add mainHeader', 'The website requires a mainHeader with the company logo.', 4, 'CLOSED', 1);
